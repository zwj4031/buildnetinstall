...
grub-mkimage -d ./grub/i386-pcgf -c ./arch/legacy-pxe/pxefm.cfg -o netinstall.pcbiosgf -O i386-pc-pxe -prefix="(pxe)" $modules
...
mv netinstall.pcbiosgf tftpboot/
...
cp tftpboot/netinstall.pc* /mnt/s/netinstall-master/
sudo rm -rf tftpboot
